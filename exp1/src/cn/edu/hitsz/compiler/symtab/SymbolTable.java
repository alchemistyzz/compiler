...
public class SymbolTable {
     ...
     */
    private static final Map<String, SymbolTableEntry> symbolTableMap = new HashMap<String, SymbolTableEntry>();
    private static final SourceCodeType sourceCodeType = SourceCodeType.Int;
    public SymbolTableEntry get(String text) {
        if(!has(text)) {
            SymbolTableEntry symbolTableEntry = new SymbolTableEntry(text);
            symbolTableEntry.setType(sourceCodeType);
...
//        throw new NotImplementedException();
    ...
    public SymbolTableEntry add(String text) {
        if(!has(text)){
            SymbolTableEntry symbolTableEntry = get(text);
...
//        throw new NotImplementedException();
    ...
    private Map<String, SymbolTableEntry> getAllEntries() {
        return Collections.unmodifiableMap(symbolTableMap);
//        throw new NotImplementedException();
    }
